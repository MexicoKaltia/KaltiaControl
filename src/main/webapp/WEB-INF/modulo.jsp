					     ...
					     <c:set var="count" value="${0}" />
						   <c:forEach items="${model.requestLoginVO.userEmpresaEntity}" var="userEmpresaEntity">
							<tr>
								...
								<td><a id="${count}" data-toggle="modal" data-target="#modalUser"class="btn btn-default userEmpresa">Status</a></td>
								<td><a id="${count}" data-toggle="modal" data-target="#modalUser"class="btn btn-default userEmpresa">Edicion</a></td>
							</tr>
						   <c:set var="count" value="${count+1}" />
						</c:forEach>
					</tbody>
		...
		<div class="modal-content"
			...
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal"
					aria-label="Close" id="modal_btnClose">
