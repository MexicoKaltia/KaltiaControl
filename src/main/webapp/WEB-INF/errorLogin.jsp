  ...
  <body class="text-center">
    <form:form  class="form-signin" action="login.htm" method="post" modelAttribute="userKaltiaControlFront">
      ...
      <div class="alert alert-danger">
		  <strong>Credenciales Invalidas!</strong> Intente de nuevo o pongase en contacto con su administrador de sistema.
		</div>
      <div>
      	<span>
      ...
      <p class="mt-5 mb-3 text-muted"><a href="http://www.kaltiaservicios.com">Kaltia Mexico&copy; 2020</a></p>
      <hiden class="version">10112020</hiden>
    </form:form>
