...
@NamedQueries({
	...
	@NamedQuery(query ="Select a from tc_empresa a ", name = "find empresa by All")
//	@NamedQuery(query ="Select a from tc_empresa a where a.empresaStatus in('prospecto','propuesta', 'inicio')", name = "find empresa by All")
})
