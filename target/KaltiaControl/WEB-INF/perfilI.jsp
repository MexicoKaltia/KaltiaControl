						...
						<div class="col-md-12 mb-3">
							<div class="main-card mb-3 card">
								<div class="card-body">
									...
									<table id='clientesTable' class="mb-0 table table-hover" data-row-style="rowStyle"
										data-locale="es-MX" 
										data-toggle='table' 
	        	...
	        	<form  class="" action="actualizaCliente.htm" method="post" modelAttribute="empresaEntity" >
	            	...
	            	<input id="empresaIdPerfilI"  type="hidden" name="empresaIdPerfilI">
								...
								<div class="form-group row">
									...
									<div class="col-7">
										<input id="empresaNombreCompleto" name="empresaNombreCompleto" placeholder="Nombre de Empresa Completo" class="form-control input-md" type="text" required maxlength="200" readonly>
									</div>
								</div>
								<div class="form-group row">
									<span class="col-3 col-form-label text-right colorLabel"><i class="fa fa-2x fa-asterisk"></i>IdAction</span>
									<div class="col-7">
										<input id="idAction" name="idAction"  class="form-control input-md" type="text"  required maxlength="20" readonly >
									</div>
								</div>
								<div class="form-group row">
									<span class="col-3 col-form-label text-right colorLabel"><i class="fa fa-2x fa-envelope"></i>Email</span>
									<div class="col-7">
										<input id="empresaEmail" name="empresaEmail" placeholder="Email" class="form-control input-md" type="email"   maxlength="50" readonly >
									</div>
								</div>
								<div class="form-group row">
									<span class="col-3 col-form-label text-right colorLabel"><i class="fa fa-2x fa-cog"></i>Status</span>
									<div class="col-7">
										<input id="empresaStatus" name="empresaStatus" placeholder="Status" class="form-control input-md" type="text" readonly >
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-7">
									<input id="empresaModoPago" name="empresaModoPago"  class="form-control input-md" type="text"  readonly>
